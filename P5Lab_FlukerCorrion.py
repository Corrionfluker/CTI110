...
def main():
    ...
    print()
    #promt the user to enter a float as the cash they will put in the chechout machine
    amount_paid=float(input("How much cash will you put in he self-checkout?"))
    print()
